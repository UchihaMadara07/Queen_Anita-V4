...
global.anitav4 = process.env.BOT_NAME || "★ σвιтσ-кυη ★";
global.ownername = process.env.OWNER_NAME || "★ σвιтσ-кυη ★";
global.packname = process.env.PACK_NAME || "★ σвιтσ-кυη ★";
global.author = process.env.AUTHOR || "★ σвιтσ-кυη ★";
global.channelname = process.env.CHANNEL_NAME || "★ σвιтσ-кυη ★";
